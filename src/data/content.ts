export const apps = [
  ...
  { id: 4, name: "Pride", category: "Social Media", description: "Social media sentiment analysis and brand monitoring", icon: "Heart" },
  ...
  { id: 9, name: "YieldFlow", category: "Finance", description: "Revenue optimization and financial forecasting platform", icon: "TrendingUp" },
...
export const categories = ["All", "Social Media", "Business", "Health", "Finance", "Education", "Creative", "Professional", "Logistics", "Property"];
