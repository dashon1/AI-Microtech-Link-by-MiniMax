...
export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-16 dark:text-white">
      ...
      <p className="mb-6">AI Microtech Link ("Company," "we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you use our services, including ReachRecover AI and all related applications.</p>
